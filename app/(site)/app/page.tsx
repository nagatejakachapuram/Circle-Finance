...
import { CheckCircle2, Wallet, User, Shield, Plus, ChevronRight, Building } from "lucide-react"
              ...
              <FadeIn delay={0.5}>
                <GlassCard className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Your onchain identity is verified and ready for tokenized real estate investments
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Button asChild className="bg-gradient-to-tr from-[#3A86FF] to-[#1f6fff] text-white">
